...
Instead a summary of the scene codes purpose and crucial parts are shown and explained.

The full code can be accessed in the appendix [\ref{ch:gotcha!---full-codegot}].
